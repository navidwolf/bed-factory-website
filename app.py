...
def product_detail(id):
    products_dict = {
        1: {'title': 'تخت خواب مدل آریا', 'image': url_for('static', filename='images/product1.webp'), 'full_desc': 'تخت خواب مدل آریا با کلاف چوبی استاندارد، راحتی عالی و طراحی کلاسیک.'},
        2: {'title': 'تخت خواب مدل نیلا', 'image': url_for('static', filename='images/product2.webp'), 'full_desc': 'تخت خواب مدل نیلا با طراحی مدرن، رنگ‌بندی شیک و قابلیت سفارش سفارشی.'}
    }
...
def sitemap():
    ...
    products_dict = {1:'تخت خواب مدل آریا',2:'تخت خواب مدل نیلا'}
